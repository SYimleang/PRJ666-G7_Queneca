        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="z-50 relative">
            <ul className="grid gap-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              {/* <ListItem href="/docs" title="New QR Code">
                Generate new QR code
              </ListItem> */}
              <ListItem href="#" title="What’s this QR code?">
                Share this QR code with customers to let them check in or view
                your menu.
              </ListItem>
              <ListItem href="#" title="How to display it?">
                Print it out or display it at your restaurant entrance.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
