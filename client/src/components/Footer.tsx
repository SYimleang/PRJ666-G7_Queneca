...
export default function Footer() {
    ...
    return (
        ...
        <div>
          ...
          <p className="text-sm">Making restaurant waitlists smarter and faster.</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            <li><Link href="/our-story" className="hover:text-red-500">Our Story</Link></li>
            <li><Link href="/reviews" className="hover:text-red-500">Reviews</Link></li>
            <li><Link href="/news" className="hover:text-red-500">News</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            <li><Link href="/faqs" className="hover:text-red-500">FAQs</Link></li>
        ...
        <div>
          ...
          <p className="text-sm">
            Email: <a href="mailto:support@queneca.com" className="text-red-600 hover:underline">support@queneca.com</a><br />
            Phone: (647) 456-7890<br />
